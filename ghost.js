class Ghost {
  constructor(
    ...
    this.randomaTargetIndex = parseInt(
      Math.random() * this.randomTargetsForGhosts.length
    );
    setInterval(() => {
  ...
  changeRandomDirection() {
    this.randomaTargetIndex += parseInt(Math.random() * 4);
    this.randomaTargetIndex = this.randomaTargetIndex % 4;
  }
  ...
  moveProcess() {
    if (this.isInRangeOfPacman()) {
      ...
      this.range = randomTargetsForGhosts[this.randomaTargetIndex];
    }
